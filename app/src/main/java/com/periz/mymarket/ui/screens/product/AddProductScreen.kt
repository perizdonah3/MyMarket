        ...
        Column(
            ...
            Surface(
                ...
                AnimatedContent(
                    ...
                    AsyncImage(
                        // ✅ FIX 2: Coil cannot use drawable int directly in same fallback
                        model = targetUri ?: parse(
                            "android.resource://com.periz.mymarket/drawable/ic_launcher_background"
                        ),
            ...
            Row(
                ...
                Button(
                    onClick = {
                        ...
                        // ✅ FIX 3: basic validation to avoid crashes
